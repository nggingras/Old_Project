...
void assignation_poids(classe *classe, std::vector<double>* vClassedData_tab, int NB_PROTOTYPE, int TAILLE_PROTOTYPE);
...
void main(void)
{
	...
	while (1)
	{
		...
		if (Learn) // Si on veut seulement loader des poids
		{
			...
			assignation_poids(&classe0, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
			assignation_poids(&classe1, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
			assignation_poids(&classe2, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
			assignation_poids(&classe3, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
			assignation_poids(&classe4, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
			assignation_poids(&classe5, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
			assignation_poids(&classe6, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
			assignation_poids(&classe7, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
			assignation_poids(&classe8, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
			assignation_poids(&classe9, vClassedData_tab, NB_PROTOTYPE, TAILLE_PROTOTYPE);
...
double calcul_distance(std::vector<double> vInput, std::vector<double> vWeight)
{
	...
	for (int vector_size = 1; vector_size < vInput.size(); vector_size++)
	{
...
std::vector<double> Soustraction_vecteur(std::vector<double> vInput, std::vector<double> vWeight)
{
	...
	for (int index = 1; index < vInput.size(); index++)
	{
